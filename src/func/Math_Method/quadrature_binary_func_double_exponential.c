                                      ...
                                      const arb_t a, const arb_t eps, const arb_t dd, slong prec)
{
    ...
    //计算对y积分的上下限
    y_a_func(y_a,t_t,param_y_a,order_y_a,prec);
    y_b_func(y_b,t_t,param_y_b,order_y_b,prec);
    ...
    //计算对y积分的上下限
    y_a_func(y_a,t_s,param_y_a,order_y_a,prec);
    y_b_func(y_b,t_s,param_y_b,order_y_b,prec);
                                            ...
                                            slong prec)
{
    ...
    //计算对y积分的上下限
    y_a_func(y_a,v,param_y_a,order_y_a,prec);
    y_b_func(y_b,v,param_y_b,order_y_b,prec);
...
int integration_binary_func_double_exponential(arb_t res, my_calc_func_binary func, void* param, const slong order,
