#ifndef __PBHS_MATH_METHOD_QUADRATURE_BINARY_RECTANGLE__   /* Include guard */
#define __PBHS_MATH_METHOD_QUADRATURE_BINARY_RECTANGLE__
...
#endif // __PBHS_MATH_METHOD_QUADRATURE_BINARY_RECTANGLE__  
