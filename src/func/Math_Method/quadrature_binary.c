...
int binary_integration_gauss_kronrod_cal_y(arb_t res, const arb_t f_x,
...
//∫f(x,y)dy
int binary_integration_gauss_kronrod_iterate_y(arb_t res, const arb_t f_x,
                                      my_calc_func_binary func, void *param, const slong order,
...
//二元函数对y进行积分 ∫f(x,y)dy
void integration_binary_y(arb_t res, const arb_t f_x, my_calc_func_binary func, void* param, const slong order,
                          ...
                          slong prec)
{
    ...
    binary_integration_gauss_kronrod_iterate_y(s,f_x,func,param,order,
...
int binary_integration_gauss_kronrod_cal_y_x(arb_t res,
                                           my_calc_func_binary func, void *param, const slong order,
                                           const arb_t y_a, const arb_t y_b, const arb_t y_error,
                                           slong y_step_min , slong y_step_max,
                                           const arb_t a, const arb_t b, const arb_t error, arb_t geterro,
...
//∫[∫f(x,y)dy]dx
int binary_integration_gauss_kronrod_iterate_y_x(arb_t res,
                                               my_calc_func_binary func, void *param, const slong order,
                                               const arb_t y_a, const arb_t y_b, const arb_t y_error,
                                               slong y_step_min , slong y_step_max,
                                               const arb_t a, const arb_t b, const arb_t error,
...
void integration_binary_y_x(arb_t res, my_calc_func_binary func, void* param, const slong order,
