#ifndef __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_GAUSS_KRONROD__   /* Include guard */
#define __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_GAUSS_KRONROD__
...
#endif // __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_GAUSS_KRONROD__  
