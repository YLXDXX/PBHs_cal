#ifndef __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_DOUBLE_EXPONENTIAL__   /* Include guard */
#define __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_DOUBLE_EXPONENTIAL__
...
#endif // __PBHS_MATH_METHOD_QUADRATURE_BINARY_FUNC_DOUBLE_EXPONENTIAL__  
